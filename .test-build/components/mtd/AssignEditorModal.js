...
function AssignEditorModal({ open, record, mtdRecords, allOrders, producers, schedule, onClose, onAssign, }) {
    ...
    function handleUnassign(e) {
        ...
        onAssign(activeRecord.id, {
            ...
            ...(0, mtd_status_1.patchFromRecordStatus)("Waiting for Data"),
        });
    }
