...
function CompleteToPayrollModal({ open, record, allOrders, producers, onClose, onConfirm, }) {
    ...
    const clientPayroll = (0, pricing_display_1.computeClientPayroll)(assignedProducerObj, finalCustomerPriceNum, effectiveBreakdown, activeRateNum, activeManualPayoutNum, breakdown?.canonical_subtype_id);
