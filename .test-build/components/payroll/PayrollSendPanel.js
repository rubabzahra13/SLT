...
function PayrollSendPanel({ categoryLabel, producerNames, categoryProducers, selectedSendEditor, payPeriod, payrollRecords, allOrders, producers, }) {
    ...
    const previewItems = (0, react_1.useMemo)(() => {
        return targetProducerNames.flatMap((producerName) => {
            ...
            const rows = (0, export_csv_1.getProducerFacingPayrollRows)(payrollRecords, allOrders, producers, producerName, filterPeriod);
