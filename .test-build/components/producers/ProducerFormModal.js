    ...
    async function handleSubmit(e) {
        ...
        try {
            await onSave({
                ...
                maxMixesPerDay: producer?.maxMixesPerDay ?? producers_1.DEFAULT_MAX_MIXES_PER_DAY,
                maxProducerCostPerDay: producer?.maxProducerCostPerDay ?? producers_1.DEFAULT_MAX_PRODUCER_COST_PER_DAY,
                overtimeDays: producer?.overtimeDays ?? [],
                ratesByCategory: form.categoryRates,
                danceVoiceoverRate: form.danceVoiceoverRate > 1
                    ? form.danceVoiceoverRate / 100
                    : form.danceVoiceoverRate,
                cheerVoiceoverRate: form.cheerVoiceoverRate > 1
