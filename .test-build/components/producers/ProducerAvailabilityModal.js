...
function ProducerAvailabilityModal({ open, onClose, producer, onSave, }) {
    ...
    const [hasMaxCostCapacity, setHasMaxCostCapacity] = (0, react_1.useState)(false);
                                    ...
                                    return ((0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => toggleDay(day.id), className: (0, clsx_1.default)("flex h-11 w-11 flex-col items-center justify-center rounded-full text-[12px] font-semibold transition", active
                                            ...
                                            if (value)
                                                addOvertimeDay(value);
                                                    ...
                                                    ? "bg-brand-ink text-white shadow-sm"
                                                    : "text-brand-ink-secondary hover:text-brand-ink"), children: "Set limit" })] }), hasMaxCapacity ? ((0, jsx_runtime_1.jsxs)("div", { className: "mt-4 flex items-center justify-between rounded-2xl bg-brand-bg px-4 py-3 ring-1 ring-inset ring-black/[0.06]", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[13px] font-medium text-brand-ink", children: "Max mixes per day" }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-3", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => setMaxMixesPerDay((value) => Math.max(1, value - 1)), disabled: maxMixesPerDay <= 1, className: "flex h-8 w-8 items-center justify-center rounded-full bg-brand-elevated text-brand-ink ring-1 ring-inset ring-black/[0.06] transition hover:bg-brand-bg-subtle disabled:opacity-40", "aria-label": "Decrease limit", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Minus, { className: "h-3.5 w-3.5", strokeWidth: 2.5 }) }), (0, jsx_runtime_1.jsx)("span", { className: "min-w-[2ch] text-center text-[18px] font-semibold tabular-nums text-brand-ink", children: maxMixesPerDay }), (0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => setMaxMixesPerDay((value) => Math.min(10, value + 1)), disabled: maxMixesPerDay >= 10, className: "flex h-8 w-8 items-center justify-center rounded-full bg-brand-elevated text-brand-ink ring-1 ring-inset ring-black/[0.06] transition hover:bg-brand-bg-subtle disabled:opacity-40", "aria-label": "Increase limit", children: (0, jsx_runtime_1.jsx)(lucide_react_1.Plus, { className: "h-3.5 w-3.5", strokeWidth: 2.5 }) })] })] })) : null] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-8", children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[13px] font-semibold text-brand-ink", children: "Maximum producer cost per day" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-0.5 text-[12px] text-brand-ink-tertiary", children: "Max producer payroll cost assignable on a single day. Uses producer payout, not customer price." }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-4 flex gap-1 rounded-full bg-brand-bg p-1 ring-1 ring-inset ring-black/[0.06]", children: [(0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => setHasMaxCostCapacity(false), className: (0, clsx_1.default)("flex-1 rounded-full py-2 text-[13px] font-semibold transition", !hasMaxCostCapacity
                                                    ? "bg-brand-ink text-white shadow-sm"
                                                    : "text-brand-ink-secondary hover:text-brand-ink"), children: "No limit" }), (0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => setHasMaxCostCapacity(true), className: (0, clsx_1.default)("flex-1 rounded-full py-2 text-[13px] font-semibold transition", hasMaxCostCapacity
                                                    ? "bg-brand-ink text-white shadow-sm"
                                                    : "text-brand-ink-secondary hover:text-brand-ink"), children: "Set limit" })] }), hasMaxCostCapacity ? ((0, jsx_runtime_1.jsxs)("div", { className: "mt-4 rounded-2xl bg-brand-bg px-4 py-3 ring-1 ring-inset ring-black/[0.06]", children: [(0, jsx_runtime_1.jsxs)("label", { className: "flex items-center justify-between gap-3", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[13px] font-medium text-brand-ink", children: "Max cost per day" }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-1", children: [(0, jsx_runtime_1.jsx)("span", { className: "text-[15px] font-semibold text-brand-ink-secondary", children: "$" }), (0, jsx_runtime_1.jsx)("input", { type: "number", min: 1, step: 100, value: maxProducerCostPerDay, onChange: (e) => {
                                                                    const val = parseInt(e.target.value, 10);
                                                                    if (!isNaN(val) && val > 0)
                                                                        setMaxProducerCostPerDay(val);
                                                                }, className: "w-24 bg-transparent text-right text-[16px] font-semibold tabular-nums text-brand-ink outline-none", "aria-label": "Maximum producer cost per day in dollars" })] })] }), (0, jsx_runtime_1.jsx)("p", { className: "mt-1.5 text-[11px] text-brand-ink-tertiary", children: "Producer will show as Capacity Reached when this amount is exceeded." })] })) : null] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-8 flex items-center justify-between", children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[13px] font-semibold text-brand-ink", children: "Time off" }), (0, jsx_runtime_1.jsx)("p", { className: "mt-0.5 text-[12px] text-brand-ink-tertiary", children: "Holidays or personal days, and why." })] }), (0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: addTimeOff, className: "inline-flex h-8 items-center gap-1 rounded-full bg-brand-bg px-3 text-[13px] font-semibold text-brand-blue ring-1 ring-inset ring-black/[0.06] transition hover:bg-brand-bg-subtle", children: [(0, jsx_runtime_1.jsx)(lucide_react_1.Plus, { className: "h-3.5 w-3.5", strokeWidth: 2.5 }), "Add"] })] }), timeOff.length === 0 ? ((0, jsx_runtime_1.jsx)("p", { className: "mt-4 text-center text-[13px] text-brand-ink-tertiary", children: "No time off added yet." })) : ((0, jsx_runtime_1.jsx)("ul", { className: "mt-4 space-y-3", children: timeOff.map((entry) => ((0, jsx_runtime_1.jsxs)("li", { className: "overflow-hidden rounded-2xl bg-brand-bg ring-1 ring-inset ring-black/[0.06]", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex items-center justify-between border-b border-black/[0.06] px-3.5 py-2.5", children: [(0, jsx_runtime_1.jsx)("div", { className: "flex gap-1 rounded-full bg-brand-elevated p-0.5 ring-1 ring-inset ring-black/[0.06]", children: ["holiday", "personal"].map((type) => ((0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => {
