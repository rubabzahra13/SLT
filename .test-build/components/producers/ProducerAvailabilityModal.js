...
function ProducerAvailabilityModal({ open, onClose, producer, onSave, readOnly = false, }) {
    ...
    function isBlockedTimeOffCalendarDay(iso) {
        if (getBlockedTimeOffDays().includes(iso))
            return true;
        if ((0, producer_time_off_1.isStudioHolidayIso)(iso, holidays))
            return true;
    ...
    function addOvertimeDay(iso) {
        ...
        if ((0, producer_time_off_1.isStudioHolidayIso)(value, holidays))
            return;
    ...
    const upcomingStudioHolidays = holidays
        .map((holiday) => {
    ...
    function timeOffDayTitle(iso, disabled) {
        ...
        const holidayNames = (0, producer_time_off_1.studioHolidayNamesForIso)(iso, holidays);
