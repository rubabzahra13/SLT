...
function FilterMenu({ label, value, options, onChange, accent = "blue", className, hideLabel = false, grouped = false, portal = false, portalZIndex = 100, }) {
    ...
    const menuContent = ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: options.map((opt) => {
            ...
            return ((0, jsx_runtime_1.jsxs)("button", { type: "button", onClick: () => {
                    ...
                    : "text-brand-ink-secondary"), children: [(0, jsx_runtime_1.jsxs)("span", { className: "flex min-w-0 items-center gap-2", children: [active ? ((0, jsx_runtime_1.jsx)(lucide_react_1.Check, { className: "h-3.5 w-3.5 shrink-0 text-brand-signature", strokeWidth: 2.5 })) : ((0, jsx_runtime_1.jsx)("span", { className: "h-3.5 w-3.5 shrink-0", "aria-hidden": true })), (0, jsx_runtime_1.jsx)("span", { className: (0, clsx_1.default)("truncate", opt.isRed && "text-red-600 font-medium dark:text-red-400"), children: opt.label })] }), opt.count !== undefined ? ((0, jsx_runtime_1.jsx)("span", { className: "shrink-0 text-[12px] tabular-nums text-brand-ink-tertiary", children: opt.count })) : null] }, opt.value));
        }) }));
