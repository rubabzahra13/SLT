...
class Producer(Base):
    ...
    dance_voiceover_rate = Column(Numeric(5, 4), nullable=True)
    cheer_voiceover_rate = Column(Numeric(5, 4), nullable=True)
    rush_fee_rate = Column(Numeric(5, 4), nullable=True)
